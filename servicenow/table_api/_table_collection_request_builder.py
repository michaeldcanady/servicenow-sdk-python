...
from servicenow.table_api.request_configuration_table_get import (
    TableCollectionGetRequestConfigurations
)
from servicenow.table_api._table_post_request_configuration import (
...
class TableCollectionRequestBuilder[_E](RequestBuilder):
